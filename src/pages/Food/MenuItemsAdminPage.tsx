          ...
          <TableBody>
            ...
            {items.map((i) => (
              <TableRow key={i._id}>
                ...
                <TableCell>
                  <Switch checked={i.isActive} disabled />
                </TableCell>
        ...
        <DialogContent>
          ...
          <FormControl fullWidth margin='dense'>
            ...
            <Select
              ...
              label='Приём пищи'
              onChange={(e) =>
                setEditItem((i) => ({ ...i, meal: e.target.value }))
              }
            >
              {MEALS.map((m) => (
          ...
          <FormControl fullWidth margin='dense'>
            ...
            <Select
              value={editItem?.group || 'all'}
              label='Группа'
              onChange={(e) =>
                setEditItem((i) => ({ ...i, group: e.target.value }))
              }
            >
              {GROUPS.map((g) => (
          ...
          <TextField
            ...
            onChange={(e) =>
              setEditItem((i) => ({
                ...i,
                vitaminDose: Number(e.target.value),
              }))
            }
            fullWidth
            margin='dense'
          ...
          <TextField
            ...
            value={editItem?.unit || ''}
            onChange={(e) =>
              setEditItem((i) => ({ ...i, unit: e.target.value }))
            }
            fullWidth
            margin='dense'
          />
          <FormControlLabel
            control={
              <Switch
                ...
                onChange={(e) =>
                  setEditItem((i) => ({ ...i, isActive: e.target.checked }))
                }
              />
            }
            label='Активно'
          ...
          <TextField
            ...
            onChange={(e) =>
              setEditItem((i) => ({ ...i, notes: e.target.value }))
            }
            fullWidth
            margin='dense'
          />
