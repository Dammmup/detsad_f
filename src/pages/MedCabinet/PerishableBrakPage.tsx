...
import { perishableBrakApi, PerishableBrak } from '../../services/perishableBrak';
      ...
      <Dialog open={open} onClose={handleClose} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          <Stack spacing={2} mt={1}>
            ...
            <TextField label="Оценка" name="assessment" value={form.assessment} onChange={handleChange} fullWidth />
