      ...
      sections: [
        {
          ...
          children: [
            ...
            new Paragraph({ text: '' }),
            new Paragraph({
              text: 'Общая медицинская информация',
            ...
            new Paragraph({ text: '' }),
            new Paragraph({
              text: 'Перенесенные инфекционные заболевания',
              heading: HeadingLevel.HEADING_2,
            }),
    ...
    <Box sx={{ p: { xs: 1, md: 3 }, maxWidth: 700, mx: 'auto' }}>
      <Paper sx={{ p: { xs: 1, md: 3 } }}>
        ...
        <Stack spacing={2}>
          ...
          <TextField
            label='Поликлиника прикрепления'
            name='clinic'
            value={form.clinic}
            onChange={handleChange}
            fullWidth
          ...
          <TextField
            label='Группа инвалидности (если есть)'
            name='disability'
