            ...
            <Dialog open={modalOpen} onClose={() => setModalOpen(false)}>
                ...
                <DialogContent>
                    <TextField
                        ...
                        onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, date: e.target.value }))}
                        fullWidth
                        margin="dense"
                    />
                    <FormControl fullWidth margin="dense">
                        <InputLabel>Группа</InputLabel>
                        <Select value={newRecord.group || ''} label="Группа" onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, group: e.target.value }))}>
                            {GROUPS.map(g => <MenuItem key={g} value={g}>{g}</MenuItem>)}
                        </Select>
                    </FormControl>
                    <FormControl fullWidth margin="dense">
                        <InputLabel>Приём пищи</InputLabel>
                        <Select value={newRecord.meal || ''} label="Приём пищи" onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, meal: e.target.value }))}>
                            {MEALS.map(m => <MenuItem key={m} value={m}>{m}</MenuItem>)}
                        </Select>
                    </FormControl>
                    <TextField
                        ...
                        onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, dish: e.target.value }))}
                        fullWidth
                        margin="dense"
                    />
                    <TextField
                        ...
                        onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, dose: Number(e.target.value) }))}
                        fullWidth
                        margin="dense"
                    />
                    <TextField
                        ...
                        onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, portions: Number(e.target.value) }))}
                        fullWidth
                        margin="dense"
                    />
                    <TextField
                        ...
                        onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, nurse: e.target.value }))}
                        fullWidth
                        margin="dense"
                    />
                    <FormControl fullWidth margin="dense">
                        <InputLabel>Статус</InputLabel>
                        <Select value={newRecord.status || ''} label="Статус" onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, status: e.target.value as any }))}>
                            {STATUS.map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
                        </Select>
                    </FormControl>
                    <TextField
                        ...
                        onChange={e => setNewRecord((r: Partial<VitaminizationRecord>) => ({ ...r, notes: e.target.value }))}
                        fullWidth
                        margin="dense"
                    />
                </DialogContent>
