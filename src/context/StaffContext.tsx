...
import {
  ...
  getStaffRoles as getStaffRolesApi,
...
export const StaffProvider = ({ children }) => {
  ...
  const fetchStaff = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: STAFF_ACTIONS.FETCH_STAFF_ERROR, payload: error.message });
      throw error;
    }
  }, []);

  const fetchStaffMember = useCallback(async (id) => {
    ...
    try {
      ...
      dispatch({ type: STAFF_ACTIONS.FETCH_STAFF_MEMBER_ERROR, payload: error.message });
      throw error;
    }
  }, []);
  ...
  const addStaff = useCallback(async (staffData) => {
    ...
    try {
      ...
      dispatch({ type: STAFF_ACTIONS.CREATE_STAFF_ERROR, payload: error.message });
      throw error;
    }
  }, []);
  ...
  const updateStaff = useCallback(async (id, staffData) => {
    ...
    try {
      ...
      dispatch({ type: STAFF_ACTIONS.UPDATE_STAFF_ERROR, payload: error.message });
      throw error;
    }
  }, []);
  ...
  const removeStaff = useCallback(async (id) => {
    ...
    try {
      ...
      dispatch({ type: STAFF_ACTIONS.DELETE_STAFF_ERROR, payload: error.message });
      throw error;
    }
  }, []);
  ...
  const fetchRoles = useCallback(async () => {
    ...
    try {
      ...
      dispatch({ type: STAFF_ACTIONS.FETCH_ROLES_ERROR, payload: error.message });
      throw error;
    }
  }, []);
